...
//
////TODO DELETE ARBITRARILY SETTING USER ID.
//
//namespace Biped.Multiplayer.Photon
//{
//    /// <summary>This class is a facade and interface with Photon's LoadBalancingClient.</summary>
//    public class PhotonClient : MonoSingleton<PhotonClient>, ILoadBalancingClientFacade, IConnectionCallbacks, IMatchmakingCallbacks, IInRoomCallbacks, IOnEventCallback
//    {
...
//                return;
//
//            EventManager.Instance.RegisterEvent(EEvent.EQuickGame, OnQuittingGame);
//
...
//                return;
//
//            EventManager.Instance.RemoveEvent(EEvent.EQuickGame, OnQuittingGame);
//
